...
Converting an ecocomDP dataset to another model format can be as simple as calling a single function. Currently, we support conversion to the Darwin Core Archive (DwC-A) Event Core.
